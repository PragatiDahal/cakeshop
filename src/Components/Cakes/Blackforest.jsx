...
const Blackforest = ({ onAddToCart }) => {
  ...
  return (
    <div className="flex flex-col flex-wrap max-w-lg mx-auto p-8  bg-white rounded-lg shadow-lg">
      <h2 className="text-3xl font-semibold text-center text-gray-800 mb-4">Black Forest Cake</h2>
      <img
        className="w-full h-auto md:w-[450px] md:h-[450px] rounded-md mb-4"
        src="https://i.pinimg.com/564x/57/b3/47/57b3476a6334405d40474424dc7bfb98.jpg"
        alt="Chocolate Cake"
      />
