...
const Fruittoppings = ({ onAddToCart }) => {
  ...
  return (
    <div className="flex flex-col flex-wrap max-w-lg mx-auto p-8  bg-white rounded-lg shadow-lg">
      <h2 className="text-3xl font-semibold text-center text-gray-800 mb-4">Fruit toppings Cake</h2>
      <img
        className="w-full h-auto md:w-[450px] md:h-[450px] rounded-md mb-4"
        src="https://i.pinimg.com/564x/df/2a/f8/df2af821400f1a34c419357c4f6ddcf0.jpg"
        alt="Chocolate Cake"
      />
