...
export const Heartshape = ({ onAddToCart }) => {
  ...
  return (
    <div className="flex flex-col flex-wrap max-w-lg mx-auto p-8  bg-white rounded-lg shadow-lg">
      <h2 className="text-3xl font-semibold text-center text-gray-800 mb-4">Heartshape Cake</h2>
      <img
        className="w-full h-auto md:w-[450px] md:h-[450px] rounded-md mb-4"
        src="https://i.pinimg.com/564x/15/b9/da/15b9daea8581a04dac3cf120caa5a26e.jpg"
        alt="Chocolate Cake"
      />
